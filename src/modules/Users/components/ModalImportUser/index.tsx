  ...
  return (
    <Container open={isVisible} onClose={handleVisibleModal}>
      <ContainerCreateData>
        ...
        <select name="companies" id="admin" value={companySelected} onChange={e => setCompanySelected(e.target.value)}>
          {companies.concat({ id: '', name: 'selecionar empresa', form_id: '' }).map(company => (
